...
public class IluminacionActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Control de iluminación");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            intent= new Intent(IluminacionActivity.this,ConfiguracionesActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_principal) {
            intent= new Intent(IluminacionActivity.this,MainActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("correo",correo);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(IluminacionActivity.this,HabitacionesActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("correo",correo);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(IluminacionActivity.this,SensoresActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("correo",correo);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(IluminacionActivity.this,NotificacionesActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("correo",correo);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(IluminacionActivity.this,ContactenosActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("correo",correo);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(IluminacionActivity.this,ActuadoresActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("correo",correo);
            startActivity(intent);
            finish();
            ...
            intent=new Intent(IluminacionActivity.this,LoginActivity.class);
